...
public class ReworkedPlayerAnimation : MonoBehaviour
{
    private ReworkedPlayerMovement mov;
    ...
    private void Start()
    {
        mov = GetComponent<ReworkedPlayerMovement>();
    ...
    private void LateUpdate()
    {
        ...
        jumpPSettings.startColor = new ParticleSystem.MinMaxGradient(new Color(155,155,200));
        ParticleSystem.MainModule landPSettings = _landParticle.main;
        landPSettings.startColor = new ParticleSystem.MinMaxGradient(new Color(155, 200, 200));
    }
